...
if(request.getAttribute(Constants.TEMPLATE_DETAILS)!=null)	
	templateList = (Templates[])request.getAttribute(Constants.TEMPLATE_DETAILS);
      ...
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t$(\"#subcategoryfrm\").submit();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\tvar accessLevelField = document.getElementById(\"subcategoryfrm\").accessLevel;\r\n");
      out.write("\t\t\t\t\tvar isHomePage = document.getElementById(\"subcategoryfrm\").isHomePage;\r\n");
      ...
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t   var selectedIndex = document.subcategoryfrm.template.selectedIndex;\r\n");
      out.write("\t\t\t   var selectedText = document.subcategoryfrm.template.options[selectedIndex].text;\r\n");
...
String message = (String) request.getAttribute(Constants.MESSAGE);
      ...
      out.write("\t\t\t\t\t\t<form class=\"ins\" id=\"subcategoryfrm\" name=\"subcategoryfrm\" action=\"subcategory\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t<fieldset>\r\n");
...
if(templateList!=null && templateList.length > 0){
      ...
      out.write("\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div id=\"admin_body_content_checkbox_submenu\">\r\n");
