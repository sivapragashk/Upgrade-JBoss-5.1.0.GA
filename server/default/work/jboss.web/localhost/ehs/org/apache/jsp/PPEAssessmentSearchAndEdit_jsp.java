...
import java.util.*;
import com.hd.ehs.form.EHSGeneralInformation;
import com.hd.ehs.tools.Constants;;

public final class PPEAssessmentSearchAndEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tdocument.getElementById('mode').value = \"getSearchList\";\r\n");
      out.write("\t\tdocument.getElementById('searchAssessmentForm').submit();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction editPPEAssessment(assessmentNo){\r\n");
      out.write("\t\tdocument.getElementById('mode').value = \"getPPEAssessmentDetailsForModify\";\r\n");
      out.write("\t\tdocument.getElementById('ppeAssessmentNo').value = assessmentNo;\r\n");
      out.write("\t\tdocument.getElementById('searchAssessmentForm').submit();\r\n");
      out.write("\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction deletePPEAssessment(assessmentNo){\r\n");
      out.write("\t\tif(confirm(\"Are you sure that you want to delete?\")){\r\n");
      out.write("\t\tdocument.getElementById('mode').value = \"deletePPEAssessmentDetails\";\r\n");
      out.write("\t\tdocument.getElementById('ppeAssessmentNo').value = assessmentNo;\r\n");
      out.write("\t\tdocument.getElementById('searchAssessmentForm').submit();\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\treturn;\r\n");
      ...
      out.write("\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction printShortFormat(assessmentNo){\r\n");
      out.write("\t\tvar jobEquipmentName = document.getElementById('jobEquipmentName').value;\r\n");
      out.write("\t\tvar path = \"searchPPEAssessment.do?mode=printPPEAssessmentDetailsShortForm&ppeAssessmentNo=\"+assessmentNo;\r\n");
      out.write("\t\tdocument.getElementById('ppeAssessmentNo').value = assessmentNo;\r\n");
      out.write("\t\twindow.open(path,'EHS','left=150,top=150,width=950,height=500,toolbar=0,resizable=0,status=0,scrollbars=1');\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction printLongFormat(assessmentNo){\r\n");
      out.write("\t\tvar jobEquipmentName = document.getElementById('jobEquipmentName').value;\r\n");
      out.write("\t\tvar path = \"searchPPEAssessment.do?mode=printPPEAssessmentDetailsLongForm&ppeAssessmentNo=\"+assessmentNo;\r\n");
      out.write("\t\tdocument.getElementById('ppeAssessmentNo').value = assessmentNo;\r\n");
      out.write("\t\twindow.open(path,'EHS','left=150,top=150,width=950,height=500,toolbar=0,resizable=0,status=0,scrollbars=1');\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction getFilterDetails(parentId,childId){\r\n");
      out.write("\t\tvar selectedId = document.getElementById(parentId);\r\n");
      out.write("\t\tvar selectedText = selectedId.options[selectedId.selectedIndex].text;\r\n");
      out.write("\t\tdocument.getElementById('locationName').value = selectedText;\r\n");
      out.write("\t\tdocument.getElementById('mode').value = \"getFilterDetails\";\r\n");
      out.write("\t\tdocument.getElementById('searchAssessmentForm').submit();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction setValue(selectBoxId,textBoxId)\r\n");
      out.write("\t{\r\n");
      out.write("\t\tvar selectedId = document.getElementById(selectBoxId);\r\n");
      out.write("\t\tvar textBox = document.getElementById(textBoxId);\r\n");
      out.write("\t\tif(selectedId.value > 0){\r\n");
      out.write("\t\t\ttextBox.value = selectedId.options[selectedId.selectedIndex].text;\r\n");
      out.write("\t\t}else{\r\n");
...
EHSGeneralInformation generalInformation = null;
int serialNo = 0;
	if(request.getAttribute("SEARCH_PPE_ASSESSMENT_DETAILS")!=null)
		list = (List)request.getAttribute("SEARCH_PPE_ASSESSMENT_DETAILS");
      ...
      out.write("\t<div id=\"mainheader\">PPE ASSESSMENT SEARCH / EDIT </div>\r\n");
      out.write("\t<div>&nbsp;</div>\r\n");
 ...
 String message = (String) request.getAttribute(Constants.MESSAGES);
      ...
      // /PPEAssessmentSearchAndEdit.jsp(84,1) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setStyleId("searchAssessmentForm");
      // /PPEAssessmentSearchAndEdit.jsp(84,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setAction("/searchPPEAssessment.do");
      // /PPEAssessmentSearchAndEdit.jsp(84,1) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t<div id=\"searchHeader\">PPE Search Criteria: </div>\r\n");
          out.write("\t\t\t<div id=\"displayBodyContent_search\">\r\n");
          out.write("\t\t\t\t<div id=\"displayBodyContent_column_first\">\r\n");
          out.write("\t\t\t\t\t<div id=\"displayBodyContent_Text\">Location :  </div>\r\n");
          out.write("\t\t\t\t\t<div id=\"displayBodyContent_Select\" style=\"padding-left: 42px;float:left\">\r\n");
          out.write("\t\t\t\t\t\t\t");
          ...
          out.write(" \r\n");
          out.write("\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t<div id=\"displayBodyContent_Text\" style=\"padding-left: 115px;float:left\">Department : </div>\r\n");
          out.write("\t\t\t\t\t<div id=\"displayBodyContent_Select\" style=\"padding-left: 72px;float:left\">\r\n");
          out.write("\t\t\t\t\t\t");
          ...
          out.write("\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t<div id=\"displayBodyContent_column_second\">\r\n");
          out.write("\t\t\t\t\t<div id=\"displayBodyContent_Text\">PPE Number : </div>\r\n");
          out.write("\t\t\t\t\t<div id=\"displayBodyContent_Select\">\r\n");
          out.write("\t\t\t\t\t\t");
          ...
          out.write("</div>\r\n");
          out.write("\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t<div id=\"displayBodyContent_Text\" style=\"padding-left: 30px;float:left\"> Job/Equipment Name : </div>\r\n");
          out.write("\t\t\t\t\t<div id=\"displayBodyContent_Select\">\r\n");
          out.write("\t\t\t\t\t\t");
          ...
          out.write("\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t<div id=\"button\" style=\"text-align: center; width: 300px; margin-left: 120px;padding-top:0px;\"><input type=\"button\" class=\"buttonStyle\" name=\"Search\" value=\"Search\" onclick=\"search()\" size=\"50\"/></div>\r\n");
          out.write("\t\t\t</div>\r\n");
          out.write("\t\t\t<div id=\"displayBodyContent_search_ByDates\" >\r\n");
          out.write("\t\t\t\t<div>\r\n");
          out.write("\t\t\t\t\t<div id=\"searchByDate\">PPE Search By Dates: </div>\r\n");
          out.write("\t\t\t\t\t<div id=\"displayBodyContent_Text\">PPE Assessments Older Than </div>\r\n");
          out.write("\t\t\t\t\t<div style=\"padding-left:200px;padding-bottom:10px;\">\r\n");
          out.write("\t\t\t\t\t\t<input type=\"text\" id=\"startDate\" name=\"startDate\" value=\"\" size=\"20\" maxlength=\"5\" />\r\n");
          out.write("\t\t\t\t\t\t<A href=\"javascript:show_calendar('searchAssessmentForm.startDate');\"><IMG alt=\"Calendar\" height=16 src=\"images/calendar.gif\" width=16 border=0></A>\r\n");
          out.write("\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t<div>\r\n");
          out.write("\t\t\t\t\t<div id=\"displayBodyContent_Text\">PPE Created or Revised Since </div>\r\n");
          out.write("\t\t\t\t\t<div style=\"padding-left:200px;padding-bottom:10px;\">\r\n");
          out.write("\t\t\t\t\t\t<input type=\"text\" id=\"endDate\" name=\"endDate\" value=\"\" size=\"20\" maxlength=\"5\" />\r\n");
          out.write("\t\t\t\t\t\t<A href=\"javascript:show_calendar('searchAssessmentForm.endDate');\"><IMG alt=\"Calendar\" height=16 src=\"images/calendar.gif\" width=16 border=0></A>\r\n");
          out.write("\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t<div id=\"button\" style=\"text-align: center; width: 300px; margin-left: 120px;\"><input type=\"button\" class=\"buttonStyle\" name=\"Search\" value=\"Search\" size=\"50\"/></div>\r\n");
          out.write("\t\t\t\t<div>&nbsp;</div>\r\n");
          out.write("\t\t\t</div>\r\n");
          out.write("\t\t</div>\r\n");
          out.write("\t</div>\r\n");
...
if(list !=null && list.size() > 0){ 
          out.write("\r\n");
          out.write("\t\t\t<div style=\"float: left; width: 500px; padding-left: 140px; padding-bottom: 10px;\"> <div id=\"displayBodyContent_Text\">Search Results :  </div> </div>\r\n");
          out.write("\t\t\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"1\" width=\"75%\" align=\"center\" id=\"searchTable\">\r\n");
          out.write("\t\t\t\t<tr>\r\n");
          out.write("\t\t\t\t\t<td style=\"font-size:12px;\">Sl.No</td>\r\n");
          out.write("\t\t\t\t\t<td width=\"25%\" style=\"font-size:12px;\">PPE Assessment No.</td>\r\n");
...
for(int i=0;i<list.size();i++){ 
						...
						if(obj instanceof String){
							assessmentNo = (String)obj;
						}else if(obj instanceof EHSGeneralInformation){
							generalInformation = (EHSGeneralInformation)obj;
						}
						serialNo = serialNo + 1;
...
if(assessmentNo !=null){
          ...
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t</td>\r\n");
          out.write("\t\t\t\t\t\t\t<td> <a href=\"javascript:editPPEAssessment('");
          out.print(assessmentNo);
          out.write("')\" class=\"menulink\"/>Edit </td>\r\n");
          out.write("\t\t\t\t\t\t\t<td> <a href=\"javascript:deletePPEAssessment('");
          out.print(assessmentNo);
          out.write("')\" class=\"menulink\"/>Delete </td>\r\n");
          out.write("\t\t\t\t\t\t\t<td> <a href=\"javascript:printShortFormat('");
          out.print(assessmentNo);
          out.write("')\" class=\"menulink\"/>Print Short Format</td>\r\n");
          out.write("\t\t\t\t\t\t\t<td> <a href=\"javascript:printLongFormat('");
          out.print(assessmentNo);
          out.write("')\" class=\"menulink\"/>Print Long Format</td>\r\n");
          out.write("\t\t\t\t\t\t\t\t");
}else if(generalInformation !=null){
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t<td>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t");
          out.print(generalInformation.getPpeAssessmentNo());
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t</td>\r\n");
          out.write("\t\t\t\t\t\t\t<td> <a href=\"javascript:editPPEAssessment('");
          out.print(generalInformation.getPpeAssessmentNo());
          ...
          out.write("\t\t\t\t<div>&nbsp;</div>\r\n");
          out.write("\t\t\t<div id=\"message\">\r\n");
          out.write("\t\t\t\t\tPPE Assessments are not available for the above search criteria.\r\n");
          out.write("\t\t\t</div>\r\n");
          out.write("\t\t");
}
          out.write("\r\n");
  ...
  private boolean _jspx_meth_html_005fselect_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(92,7) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f0.setProperty("location");
    // /PPEAssessmentSearchAndEdit.jsp(92,7) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f0.setStyleId("location");
    // /PPEAssessmentSearchAndEdit.jsp(92,7) name = onchange type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f0.setOnchange("getFilterDetails('location','department')");
  ...
  private boolean _jspx_meth_html_005foption_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(93,8) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005foptionsCollection_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(94,9) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f0.setProperty("locationList");
    // /PPEAssessmentSearchAndEdit.jsp(94,9) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f0.setValue("locationId");
    // /PPEAssessmentSearchAndEdit.jsp(94,9) name = label type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f0.setLabel("location");
  ...
  private boolean _jspx_meth_html_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(96,7) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f0.setProperty("locationName");
    // /PPEAssessmentSearchAndEdit.jsp(96,7) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f0.setStyleId("locationName");
  ...
  private boolean _jspx_meth_html_005fselect_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(100,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f1.setProperty("department");
    // /PPEAssessmentSearchAndEdit.jsp(100,6) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f1.setStyleId("department");
    // /PPEAssessmentSearchAndEdit.jsp(100,6) name = onchange type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f1.setOnchange("setValue('department','departmentName')");
  ...
  private boolean _jspx_meth_html_005foption_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f1, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(101,8) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005foptionsCollection_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f1, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(102,8) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f1.setProperty("departmentList");
    // /PPEAssessmentSearchAndEdit.jsp(102,8) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f1.setValue("departmentId");
    // /PPEAssessmentSearchAndEdit.jsp(102,8) name = label type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f1.setLabel("department");
  ...
  private boolean _jspx_meth_html_005fhidden_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(104,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f1.setProperty("departmentName");
    // /PPEAssessmentSearchAndEdit.jsp(104,6) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f1.setStyleId("departmentName");
  ...
  private boolean _jspx_meth_html_005fselect_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(110,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f2.setProperty("ppeNo");
    // /PPEAssessmentSearchAndEdit.jsp(110,6) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f2.setStyleId("ppeNo");
    // /PPEAssessmentSearchAndEdit.jsp(110,6) name = onchange type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f2.setOnchange("setValue('ppeNo','hiddenPPENumber')");
  ...
  private boolean _jspx_meth_html_005foption_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f2, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(111,7) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005foptionsCollection_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f2, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(112,7) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f2.setProperty("ppeNoList");
    // /PPEAssessmentSearchAndEdit.jsp(112,7) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f2.setValue("ppeId");
    // /PPEAssessmentSearchAndEdit.jsp(112,7) name = label type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f2.setLabel("ppeNo");
  ...
  private boolean _jspx_meth_html_005fhidden_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(115,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f2.setProperty("hiddenPPENumber");
    // /PPEAssessmentSearchAndEdit.jsp(115,6) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f2.setStyleId("hiddenPPENumber");
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_005ftext_005f0 = (org.apache.struts.taglib.html.TextTag) _005fjspx_005ftagPool_005fhtml_005ftext_0026_005fstyleId_005fsize_005fproperty_005fnobody.get(org.apache.struts.taglib.html.TextTag.class);
    _jspx_th_html_005ftext_005f0.setPageContext(_jspx_page_context);
    _jspx_th_html_005ftext_005f0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_005fform_005f0);
    // /PPEAssessmentSearchAndEdit.jsp(116,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005ftext_005f0.setProperty("ppeNumber");
    // /PPEAssessmentSearchAndEdit.jsp(116,6) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005ftext_005f0.setStyleId("ppeNumber");
    // /PPEAssessmentSearchAndEdit.jsp(116,6) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005ftext_005f0.setSize("30");
    int _jspx_eval_html_005ftext_005f0 = _jspx_th_html_005ftext_005f0.doStartTag();
    if (_jspx_th_html_005ftext_005f0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _005fjspx_005ftagPool_005fhtml_005ftext_0026_005fstyleId_005fsize_005fproperty_005fnobody.reuse(_jspx_th_html_005ftext_005f0);
      return true;
    }
    _005fjspx_005ftagPool_005fhtml_005ftext_0026_005fstyleId_005fsize_005fproperty_005fnobody.reuse(_jspx_th_html_005ftext_005f0);
    return false;
  ...
  private boolean _jspx_meth_html_005fselect_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(120,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f3.setProperty("jobEquipment");
    // /PPEAssessmentSearchAndEdit.jsp(120,6) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f3.setStyleId("jobEquipment");
    // /PPEAssessmentSearchAndEdit.jsp(120,6) name = onchange type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f3.setOnchange("setValue('jobEquipment','hiddenJobEquipment')");
  ...
  private boolean _jspx_meth_html_005foption_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  html:option
    ...
    // /PPEAssessmentSearchAndEdit.jsp(121,7) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_html_005foption_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("Select Job Equipment Name");
  ...
  private boolean _jspx_meth_html_005foptionsCollection_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f3, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(122,7) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f3.setProperty("jobEquipmentList");
    // /PPEAssessmentSearchAndEdit.jsp(122,7) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f3.setValue("jobEquipmentId");
    // /PPEAssessmentSearchAndEdit.jsp(122,7) name = label type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f3.setLabel("jobEquipment");
  ...
  private boolean _jspx_meth_html_005fhidden_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(124,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f3.setProperty("hiddenJobEquipment");
    // /PPEAssessmentSearchAndEdit.jsp(124,6) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f3.setStyleId("hiddenJobEquipment");
  ...
  private boolean _jspx_meth_html_005ftext_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_005ftext_005f1 = (org.apache.struts.taglib.html.TextTag) _005fjspx_005ftagPool_005fhtml_005ftext_0026_005fstyleId_005fsize_005fproperty_005fnobody.get(org.apache.struts.taglib.html.TextTag.class);
    _jspx_th_html_005ftext_005f1.setPageContext(_jspx_page_context);
    _jspx_th_html_005ftext_005f1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_005fform_005f0);
    // /PPEAssessmentSearchAndEdit.jsp(125,12) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005ftext_005f1.setProperty("jobEquipmentName");
    // /PPEAssessmentSearchAndEdit.jsp(125,12) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005ftext_005f1.setStyleId("jobEquipmentName");
    // /PPEAssessmentSearchAndEdit.jsp(125,12) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005ftext_005f1.setSize("30");
    int _jspx_eval_html_005ftext_005f1 = _jspx_th_html_005ftext_005f1.doStartTag();
    if (_jspx_th_html_005ftext_005f1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _005fjspx_005ftagPool_005fhtml_005ftext_0026_005fstyleId_005fsize_005fproperty_005fnobody.reuse(_jspx_th_html_005ftext_005f1);
      return true;
    }
    _005fjspx_005ftagPool_005fhtml_005ftext_0026_005fstyleId_005fsize_005fproperty_005fnobody.reuse(_jspx_th_html_005ftext_005f1);
    return false;
  ...
  private boolean _jspx_meth_html_005fhidden_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(151,1) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f4.setProperty("mode");
    // /PPEAssessmentSearchAndEdit.jsp(151,1) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f4.setStyleId("mode");
    // /PPEAssessmentSearchAndEdit.jsp(151,1) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /PPEAssessmentSearchAndEdit.jsp(204,2) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f5.setProperty("ppeAssessmentNo");
    // /PPEAssessmentSearchAndEdit.jsp(204,2) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f5.setStyleId("ppeAssessmentNo");
    // /PPEAssessmentSearchAndEdit.jsp(204,2) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
