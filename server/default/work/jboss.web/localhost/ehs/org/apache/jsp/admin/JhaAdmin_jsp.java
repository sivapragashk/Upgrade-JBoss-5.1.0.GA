...
public final class JhaAdmin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<script>\r\n");
      out.write("\tfunction validateField(dropdown){\t\r\n");
      out.write("\tvar selectedField = dropdown.selectedIndex;\r\n");
      out.write("\tif(selectedField =='1'){\r\n");
      out.write("\tdocument.getElementById('addButton').disabled = true;\r\n");
      out.write("\t}\r\n");
      out.write("\telse{\r\n");
      out.write("\tdocument.getElementById('addButton').disabled = false;\r\n");
      out.write("\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction saveAdmin(formName, target){\r\n");
      out.write("\tvar selectedPage = document.jhaAdminForm.categoryMasterId.value;\r\n");
      out.write("\tvar labelName = document.getElementById('labelName').value;\r\n");
      out.write("\t\r\n");
      out.write("\tvar tableLength = document.getElementById('tblField').rows.length;\r\n");
      out.write("\tvar path= \"jhaAdminAction.do\";\r\n");
      out.write("\tvar selectedField = jhaAdminForm.fieldType.options[jhaAdminForm.fieldType.selectedIndex].value;\r\n");
      out.write("\t\r\n");
      out.write("\tif(selectedPage == '0'){\r\n");
      out.write("\talert('Please select Page');\r\n");
      out.write("\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\telse if(labelName == ''){\r\n");
      out.write("\talert('Please Enter Label Name');\r\n");
      out.write("\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\telse if(selectedField =='Select Field'){\r\n");
      out.write("\talert('Please Select Field Type');\r\n");
      out.write("\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\telse if(selectedField !='Text'){\r\n");
      out.write("\tif(tableLength < 2){\r\n");
      out.write("\talert('Please Add Fields');\r\n");
      out.write("\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\telse\r\n");
      out.write("\t{\r\n");
      out.write("\tvar tbl = document.jhaAdminForm.jha.length;\r\n");
      out.write("\tfor(i=0;i<tbl;i++){\r\n");
      out.write("\tif(document.jhaAdminForm.jha[i].value==''){\r\n");
      out.write("\talert('Please Enter values to continue');\r\n");
      out.write("\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t}\t\r\n");
      out.write("\t\r\n");
      out.write("   \tdocument.forms[formName].mode.value = target;     \r\n");
      out.write("   \tdocument.forms[formName].submit();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction setRowValue(doc,fieldname,rownum){\t\t\t     \r\n");
      out.write("\t\t      doc.ppeRowId.value=rownum;\t\t     \r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t</script>\r\n");
      out.write("\r\n");
      ...
      // /admin/JhaAdmin.jsp(73,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setAction("/jhaAdminAction.do");
      // /admin/JhaAdmin.jsp(73,0) name = enctype type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setEnctype("multipart/form-data");
      // /admin/JhaAdmin.jsp(73,0) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setStyleId("jhaAdminEditForm");
      ...
      if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\r\n");
          out.write("\r\n");
          out.write("\t<div id=\"header\">Manage JHA</div>\r\n");
          out.write("\t<div>&nbsp;</div>\r\n");
          out.write("\t\r\n");
          out.write("\t");
          ...
          // /admin/JhaAdmin.jsp(80,1) name = message type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          if (_jspx_eval_logic_005fmessagesPresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              // /admin/JhaAdmin.jsp(81,2) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fmessages_005f0.setId("message");
              // /admin/JhaAdmin.jsp(81,2) name = message type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fmessages_005f0.setMessage("true");
              // /admin/JhaAdmin.jsp(81,2) name = header type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fmessages_005f0.setHeader("error.header");
              // /admin/JhaAdmin.jsp(81,2) name = footer type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          out.write("\t\t\t\t\t<div id=\"admin_body_content_text\">Page &nbsp;&nbsp;</div>\r\n");
          ...
          out.write("\t\t\t\t\r\n");
          out.write("\t\t\t\t\r\n");
          out.write("\t\t\t<div id=\"admin_body_content_text\">\r\n");
          out.write("\t\t\t\t\t\t\r\n");
          out.write("\t\t\t\t\t\t\r\n");
          out.write("\t\t\t\t\t\t");
          ...
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\r\n");
          out.write("\t\t\t\t\t\t<input type=\"button\" name=\"addButton\" value=\"Add Field\" property=\"labelValue\" onclick=\"addQuestionRow(document.jhaAdminForm, 'tblField', 'jha');\">\r\n");
          out.write("\t\t\t\t\t\t<input type=\"button\" value=\"Remove Field\" onclick=\"removeQuestionRow(document.jhaAdminForm, 'tblField', 'jha');\">\r\n");
          out.write("\t\t\t\t\t\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\r\n");
          ...
          // /admin/JhaAdmin.jsp(120,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          _jspx_th_logic_005fnotEmpty_005f0.setName("jhaAdminForm");
          // /admin/JhaAdmin.jsp(120,5) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          _jspx_th_logic_005fnotEmpty_005f0.setProperty("splitValue");
          int _jspx_eval_logic_005fnotEmpty_005f0 = _jspx_th_logic_005fnotEmpty_005f0.doStartTag();
          if (_jspx_eval_logic_005fnotEmpty_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              out.write("\r\n");
              out.write("\t\t\t\t\t<table id=\"tblField\">\t\t\t\t\t  \r\n");
              out.write("\t\t\t\t\t\t  \r\n");
              out.write("\t\t\t\t\t\t  \r\n");
              out.write("\t\t\t\t\t\t  \r\n");
              out.write("\t\t\t\t\t\t  \r\n");
              ...
              // /admin/JhaAdmin.jsp(126,8) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setId("seperatedValue");
              // /admin/JhaAdmin.jsp(126,8) name = indexId type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setIndexId("rownum");
              // /admin/JhaAdmin.jsp(126,8) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setName("jhaAdminForm");
              // /admin/JhaAdmin.jsp(126,8) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_logic_005fiterate_005f0.setProperty("splitValue");
              int _jspx_eval_logic_005fiterate_005f0 = _jspx_th_logic_005fiterate_005f0.doStartTag();
              if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                java.lang.Object seperatedValue = null;
                java.lang.Integer rownum = null;
                if (_jspx_eval_logic_005fiterate_005f0 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
                  out = _jspx_page_context.pushBody();
                  _jspx_th_logic_005fiterate_005f0.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
                  _jspx_th_logic_005fiterate_005f0.doInitBody();
                }
                seperatedValue = (java.lang.Object) _jspx_page_context.findAttribute("seperatedValue");
                rownum = (java.lang.Integer) _jspx_page_context.findAttribute("rownum");
                do {
                  out.write("\r\n");
                  out.write("\t\t\t\t\t\t \r\n");
                  out.write("\t\t\t\t\t\t  \t<tr id=\"tblField\" name=\"tblField\"><td><input type=\"text\" name=\"jha\" value=\"");
                  if (_jspx_meth_bean_005fwrite_005f1(_jspx_th_logic_005fiterate_005f0, _jspx_page_context))
                    return;
                  out.write("\" size=\"30\" onclick=\"setRowValue(document.jhaAdminForm,'tblField','");
                  ...
                  if (_jspx_meth_bean_005fwrite_005f3(_jspx_th_logic_005fiterate_005f0, _jspx_page_context))
                    return;
                  out.write("-->\r\n");
                  out.write("\t\t\t\t\t\t  \t<!-- value=\"${seperatedValue}\" -->\r\n");
                  out.write("\t\t\t\t\t\t  \t");
          ...
          out.write("\t\t\t\t\t\t<a href=\"javascript:modifyJHAAdmin()\" class=\"menulink\">Modify/Delete JHA</a>\r\n");
          out.write("\t\t\t\t\t</div>\r\n");
          out.write("\t\t\t\t\t\r\n");
          out.write("\t\t\t\t\t\r\n");
          out.write("\t\t\t\t\t\t\r\n");
          ...
          out.write("\t\t\t<input type=\"button\" value=\"Save\" onclick=\"saveAdmin('jhaAdminForm','saveJHAAdminInformation')\">\r\n");
          out.write("\t\t</div>\t\r\n");
          out.write("\t\t\r\n");
          out.write("\t</div>\r\n");
          ...
          out.write("\t\t<input type=\"hidden\" name=\"labelName\">\r\n");
  ...
  private boolean _jspx_meth_bean_005fwrite_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fmessages_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(82,2) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fselect_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(93,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f0.setProperty("categoryMasterId");
    // /admin/JhaAdmin.jsp(93,8) name = styleClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f0.setStyleClass("dropdown");
    // /admin/JhaAdmin.jsp(93,8) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005foption_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(94,9) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005foptionsCollection_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(95,8) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f0.setName("categoryMasterListData");
  ...
  private boolean _jspx_meth_bean_005fmessage_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(104,6) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_bean_005fmessage_005f0.setKey("label.name");
  ...
  private boolean _jspx_meth_html_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(104,38) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005ftext_005f0.setProperty("labelName");
    // /admin/JhaAdmin.jsp(104,38) name = size type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_bean_005fmessage_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(105,6) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_bean_005fmessage_005f1.setKey("field.type");
  ...
  private boolean _jspx_meth_html_005fselect_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(106,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f1.setProperty("fieldType");
    // /admin/JhaAdmin.jsp(106,6) name = onchange type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f1.setOnchange("validateField(this.form.fieldType)");
  ...
  private boolean _jspx_meth_html_005foption_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f1, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(107,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foption_005f1.setKey("select.type");
    // /admin/JhaAdmin.jsp(107,7) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foption_005f1.setValue("Select Field");
  ...
  private boolean _jspx_meth_html_005foption_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f1, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(108,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foption_005f2.setKey("select.textbox");
    // /admin/JhaAdmin.jsp(108,7) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foption_005f2.setValue("Text");
  ...
  private boolean _jspx_meth_html_005foption_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f1, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(109,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foption_005f3.setKey("select.selectbox");
    // /admin/JhaAdmin.jsp(109,7) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foption_005f3.setValue("Select");
  ...
  private boolean _jspx_meth_html_005foption_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f1, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(110,7) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foption_005f4.setKey("select.checkbox");
    // /admin/JhaAdmin.jsp(110,7) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foption_005f4.setValue("Check");
  ...
  private boolean _jspx_meth_bean_005fwrite_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(128,84) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_bean_005fwrite_005f1.setName("seperatedValue");
  ...
  private boolean _jspx_meth_bean_005fwrite_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(128,186) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_bean_005fwrite_005f2.setName("rownum");
  ...
  private boolean _jspx_meth_bean_005fwrite_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_005fiterate_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(129,14) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_bean_005fwrite_005f3.setName("seperatedValue");
  ...
  private boolean _jspx_meth_logic_005fempty_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /admin/JhaAdmin.jsp(138,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_logic_005fempty_005f0.setName("jhaAdminForm");
    // /admin/JhaAdmin.jsp(138,5) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_logic_005fempty_005f0.setProperty("splitValue");
