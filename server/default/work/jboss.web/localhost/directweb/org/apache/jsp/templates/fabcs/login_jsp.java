...
if(contextName != null && contextName.length() > 0) {
	contextName = contextName.substring(1, contextName.length());
      ...
      out.write("<head>\r\n");
      out.write("\t<link rel=\"stylesheet\" type=\"text/css\" href=\"/DirectWeb/stylesheets/login/global.css\" media=\"screen, projection\" />\r\n");
      out.write("\t<link rel=\"stylesheet\" type=\"text/css\" href=\"/DirectWeb/stylesheets/login/template_login.css\" media=\"screen, projection\" />\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"/DirectWeb/javascript/templates/common/admin.js\"></script>\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction doSubmit(evt)\r\n");
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t var keycode;\r\n");
      out.write("\t\t\t // extract key code from event\r\n");
      out.write("\t\t\t if (navigator.appName.indexOf(\"Netscape\") != -1)\r\n");
      out.write("\t\t\t\t keycode = evt.which;\r\n");
      out.write("\t\t\t else if (navigator.appName.indexOf(\"Microsoft\") != -1)\r\n");
      out.write("\t\t\t\t keycode = window.event.keyCode;\r\n");
      out.write("\t\t\t // detect the \"Return\" key\r\n");
      out.write("\t\t\t if (keycode == 13) {\r\n");
      out.write("\t\t\t\t validate();\r\n");
      out.write("\t\t\t\t if (navigator.appName.indexOf(\"Microsoft\") != -1)\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t\t\t //SW00168184 - stop System Default Beep Sound.\r\n");
      out.write("\t\t\t\t\t window.event.keyCode = 0;\r\n");
      out.write("\t\t\t }\r\n");
      out.write("\t\t\t}\t\t\t\r\n");
      out.write("\t\t\tfunction setFieldsLogin(){\r\n");
      out.write("\r\n");
      out.write("\t \t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t{\r\n");
      out.write("\t\t\tif(document.userForm.username.value == ''){\r\n");
      out.write("\t\t\t\talert('Please enter Username to continue');\r\n");
      out.write("\t\t\t\tdocument.userForm.username.focus();\r\n");
      out.write("\t\t\t\treturn false;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\telse\r\n");
      out.write("\t\t\tif(document.userForm.password.value == ''){\r\n");
      out.write("\t\t\t\talert('Please enter Password to continue');\r\n");
      ...
      out.write("\t\t\t\tsubmitUserDetails()\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction textFocus()\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\t  document.userForm.username.onkeypress = doSubmit;\r\n");
      out.write("\t\t  document.userForm.password.onkeypress = doSubmit;\r\n");
      out.write("\t\t  document.userForm.username.focus();\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\t</script>\t\t\r\n");
      out.write("</head>\r\n");
      out.write("<body onload=\"textFocus();\">\r\n");
      out.write("\r\n");
      out.write("<div id=\"container\">\r\n");
      out.write("\t<div id=\"main\">\r\n");
      out.write("\t\t<div id=\"sidebar\">\r\n");
      out.write("\t\t\t<a href=\"/directweb/login\"><img height=\"134\" width=\"215\" src=\"/DirectWeb/images/login/logo.png\"/></a>\r\n");
      out.write("\t\t\t<h2></h2>\r\n");
      out.write("\t\t\t<ul>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t</ul>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"mainimage\"><img src=\"/DirectWeb/images/login/mainimage2.jpg\"/></div>\r\n");
      ...
      // /templates/fabcs/login.jsp(134,5) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setAction("login.do");
      // /templates/fabcs/login.jsp(134,5) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /templates/fabcs/login.jsp(135,6) name = message type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          if (_jspx_eval_logic_005fmessagesPresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              // /templates/fabcs/login.jsp(136,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fmessages_005f0.setId("message");
              // /templates/fabcs/login.jsp(136,7) name = message type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fmessages_005f0.setMessage("true");
              // /templates/fabcs/login.jsp(136,7) name = header type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fmessages_005f0.setHeader("error.header");
              // /templates/fabcs/login.jsp(136,7) name = footer type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if(cookieUserName != null && cookieUserName != "" && cookiePassword != null && cookiePassword != ""){
          ...
          out.print(Constants.GROUP_ID);
          out.write("\" value=\"");
          out.print(TextUtils.getIntValue(request.getParameter(Constants.GROUP_ID)));
          out.write("\"/>\r\n");
          out.write("\t\t\t\t\t\t");
session.setAttribute(Constants.LOGIN_MODE, "templates/fabcs/login.jsp");
          out.write("\r\n");
          out.write("\t\t\t\t\t");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write(" \t<div id=\"footer\" style=\"background: url('/DirectWeb/images/templates/fabcs/footer_bg.png')no-repeat;\">\r\n");
      out.write("\t<p>Copyright &copy;  2011 Hunter Douglas. All Rights Reserved. Hunter Douglas DirectWeb 2.0</p>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("setFieldsLogin();\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
  ...
  private boolean _jspx_meth_bean_005fwrite_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fmessages_005f0, PageContext _jspx_page_context)
    ...
    // /templates/fabcs/login.jsp(137,8) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
