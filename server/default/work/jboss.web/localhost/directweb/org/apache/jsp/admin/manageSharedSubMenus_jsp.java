...
public final class manageSharedSubMenus_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Integer groupId = 0;
List<SharedSubMenu> sharedSubMenuList = null;
Map<Integer, String> groupAccessLevels = null;
if(request.getAttribute(TemplateConstants.SHARED_SUB_MENUS) != null){
	sharedSubMenuList = (List) request.getAttribute(TemplateConstants.SHARED_SUB_MENUS);
}
...
if(group != null){
	...
	groupAccessLevels.put(Constants.PUBLIC, Constants.PUBLIC_ACCESS);
      ...
      out.write("\t\t\tdocument.getElementById(\"mode\").value = 'acceptORRejectSharedSubMenu';\r\n");
      out.write("\t\t\tdocument.getElementById(\"sharedSubMenuFrm\").submit();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t</script>\r\n");
      out.write("</head>\r\n");
...
if(TextUtils.containsValue(iconlist, PageConstants.SAVE)){
      ...
      out.write("\t\t\t</div>");
      out.write("\r\n");
      out.write("\t<div class=\"pagetitle\"><h2>Manage Shared Sub Menus</h2></div>\r\n");
      out.write("\t<div class=\"clr\"></div>\r\n");
      out.write("\t</div>\r\n");
      ...
      // /admin/manageSharedSubMenus.jsp(56,2) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fform_005f0.setStyleId("sharedSubMenuFrm");
      // /admin/manageSharedSubMenus.jsp(56,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          // /admin/manageSharedSubMenus.jsp(57,3) name = message type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          if (_jspx_eval_logic_005fmessagesPresent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              // /admin/manageSharedSubMenus.jsp(61,7) name = id type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fmessages_005f0.setId("messages");
              // /admin/manageSharedSubMenus.jsp(61,7) name = message type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fmessages_005f0.setMessage("true");
              // /admin/manageSharedSubMenus.jsp(61,7) name = header type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              _jspx_th_html_005fmessages_005f0.setHeader("error.header");
              // /admin/manageSharedSubMenus.jsp(61,7) name = footer type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          out.write("\t\t\r\n");
          out.write("\t\t\t");
if(sharedSubMenuList != null && sharedSubMenuList.size() > 0){
				StringBuffer values = new StringBuffer();
				Map<Integer, Menu> menumap = MenuServiceImpl.getMenuServiceInstance().getMenus();
          out.write("\r\n");
          ...
          out.write("\t\t\t\t\t\t\t<th>Sub Menu</th>\r\n");
          out.write("\t\t\t\t\t\t\t<th>Access Levels</th>\r\n");
          out.write("\t\t\t\t\t\t</tr>\r\n");
          out.write("\t\t\t\t\t</thead>\t\t\r\n");
          out.write("\t\t\t\t\t");
values.append("<tbody>");	
					  Iterator<SharedSubMenu> iterator = sharedSubMenuList.iterator();
					  int count = 0;
						while(iterator.hasNext()){
							SharedSubMenu sharedSubMenu = iterator.next();
							String accesslevels = sharedSubMenu.getAccessLevels();
							...
							values.append("<td>");
							values.append("<input type=\"checkbox\" name=\""+TemplateConstants.SUB_MENU_ID+"\""); 
							values.append(" value=\""+sharedSubMenu.getSubMenu().getSubMenuId()+"\"");
							values.append(" class=\"checkbox-nostyle\" />");
							values.append("</td>");
							values.append("<td>");
							values.append(sharedSubMenu.getStatus());
							values.append("</td>");
							values.append("<td>");
							values.append(TextUtils.getMenu(menumap, sharedSubMenu.getMenuId()));
							values.append("</td>");
							values.append("<td>");
							values.append(sharedSubMenu.getSubMenu().getSubMenuName());
							values.append("</td>");
							values.append("<td>");
								if(groupAccessLevels != null && groupAccessLevels.size() > 0){
									...
									while(groupAccessIterator.hasNext()){
										...
										values.append("<input type=\"checkbox\" name=\""+Constants.GROUP_ACCESS_LEVELS+"_"+sharedSubMenu.getSubMenu().getSubMenuId()+"\""); 
  ...
  private boolean _jspx_meth_bean_005fwrite_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fmessages_005f0, PageContext _jspx_page_context)
    ...
    // /admin/manageSharedSubMenus.jsp(62,8) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
