...
if(request.getAttribute(TemplateConstants.TEMPLATE_CONTENT) != null){
  ...
  if(contentmap != null && contentmap.get(SectionReference.getSectionId(TemplateConstants.SECTION_MAIN_HEADER)) != null){
      ...
      out.write("\t\t\t");
if(contentmap != null && contentmap.get(SectionReference.getSectionId(TemplateConstants.SECTION_BODY_CONTENT)) != null){
				List contentlist = (LinkedList) contentmap.get(SectionReference.getSectionId(TemplateConstants.SECTION_BODY_CONTENT));
				if(contentlist!=null && contentlist.size() > 0){	
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t");
      out.print(HTMLUtils.generateLinks(content,SectionReference.getSectionId(TemplateConstants.SECTION_BODY_CONTENT),editmode,approvalmode, enablesort));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t");
}	
      ...
      out.write("\t\t\t\t\t<a href=\"javascript:loadTemplateItems(");
      out.print(SectionReference.getSectionId(TemplateConstants.SECTION_BODY_CONTENT));
      out.write(")\" id=\"admin_template_insert_link\">Insert Content</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t");
}
